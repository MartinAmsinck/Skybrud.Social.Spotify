...
namespace Skybrud.Social.Spotify.Models.Tracks {
    ...
    /// <see>
    ///     <cref>https://developer.spotify.com/web-api/object-model/#track-object</cref>
    /// </see>
    public class SpotifyTrack : SpotifyObject {
        ...
        /// <summary>
        /// Gets the disc number (usually <code>1</code> unless the album consists of more than one disc).
        /// </summary>
        ...
        /// <summary>
        /// Gets whether or not the track has explicit lyrics (<code>true</code> = yes it does; <code>false</code> = no it does not OR unknown).
        /// </summary>
        ...
        protected SpotifyTrack(JObject obj) : base(obj) {
