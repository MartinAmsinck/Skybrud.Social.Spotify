...
namespace Skybrud.Social.Spotify.Scopes {
    ...
    public class SpotifyScopeCollection {
        ...
        /// </summary>
        /// <returns>An array of the <see cref="SpotifyScope"/> contained in the location.</returns>
        ...
        /// </summary>
        /// <returns>An array of <see cref="System.String"/> representing each scope in the collection.</returns>
        ...
        /// <summary>
        /// Adds <paramref name="scope"/> to <paramref name="collection"/>.
        /// </summary>
